...
All citations have been verified against fetched sources as of 2026-05-31 (paper_state/source_verification.md). The Henriksson entry carries a [NOTE] correcting the venue from "RefSQ 2023 / IEEE" to SEAA 2019; see that entry for details.
...
- Henriksson et al., "Performance Analysis of Out-of-Distribution Detection on Various Trained Neural Networks," 45th Euromicro Conference on Software Engineering and Advanced Applications (SEAA 2019), IEEE, arXiv:2103.15580. Empirical OOD-detector comparison on neural networks trained for safety-critical applications; standard citation for OOD as part of the AV safety lifecycle. [NOTE: venue corrected from "RefSQ 2023 / IEEE" to SEAA 2019; the REFSQ 2023 Henriksson paper has a different title and author list -- see below for details.]
