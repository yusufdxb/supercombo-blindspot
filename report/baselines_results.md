...
| Conformal (split-CP) | Yes | KNN nonconformity score wrapped in inductive conformal p-values; distribution-free FPR under exchangeability. |
...
- threshold (calibrated on all real corpora, p=99.0): 0.986901
