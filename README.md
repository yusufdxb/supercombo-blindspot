...
held-out false-positive rate (2.07% max across folds)**. The two
...
0.550, while E4's output-collapse cliff does not arrive until alpha
~ 0.78. A tiny external monitor watching internals could flag the OOD
